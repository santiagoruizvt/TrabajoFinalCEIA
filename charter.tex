...
\begin{document}
	...
	El proyecto se encuentra en una etapa de prueba de concepto. En esta, se busca validar la viabilidad técnica de estimar la frecuencia cardíaca a partir de video, y a partir de esa misma señal, obtener una estimación de la frecuencia respiratoria. Para ello, se compara el desempeño de un enfoque clásico y uno basado en \textit{deep learning} sobre datasets públicos reconocidos en la literatura de rPPG. Estos enfoques serán contrastados con mediciones de referencia obtenidas con sensores de contacto.
