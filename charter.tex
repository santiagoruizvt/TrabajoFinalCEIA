...
\pertenenciaDirector{Docente FIUBA} 
...
\fechaFINALTrabajo{XX de XXXX de 2027}	%Fecha de defensa pública del trabajo final
...
\begin{document}
	...
	\begin{itemize}
		...
		\item Usuario final: el profesional de la salud valora la rapidez y la no invasividad de la medición; el paciente valora no depender de instrumental adicional ni de conocimientos técnicos para su uso.
	\end{itemize}
	...
	\begin{itemize}
		\item Los datasets públicos utilizados (UBFC-rPPG, PURE) se encuentran disponibles y accesibles durante todo el desarrollo del proyecto.
