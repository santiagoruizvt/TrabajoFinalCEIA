...
\begin{document}
	...
	\begin{table}[ht]
		...
		\begin{tabularx}{\linewidth}{@{}|c|X|c|@{}}
			...
			3      & Se completa hasta el punto 12 inclusive                & 20 de septiembre de 2026 \\ \hline
	...
	Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en {la implementación de un sistema basado en técnicas de fotopletismografía remota (rPPG) capaz de estimar, de manera no invasiva, signos vitales de una persona como la frecuencia cardíaca}. El trabajo tendrá un presupuesto preliminar estimado de {600} horas y un costo estimado de ARS 16.000.600, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública en \fechaFinalName.
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item Se deben documentar las métricas obtenidas y las condiciones bajo las que se obtuvieron. (Prioridad: alta)
...
Los \textit{story points} de cada historia se calculan como la suma de tres subpuntajes, cada uno en una escala de 1 a 5: complejidad, dificultad e incertidumbre. El valor del \textit{story point} debe pertenecer siempre a la sucesión de Fibonacci.
	...
	El diagrama de Activity on Node (AoN) se construye a partir de las 22 subtareas del desglose del trabajo (WBS) definido en la sección anterior, tomando como unidad de tiempo la hora. Se identificaron relaciones de precedencia que permiten ejecutar ciertas tareas en paralelo. Esto es razonable incluso cuando se trata de un proyecto ejecutado por una única persona, dado que el entrenamiento del modelo de \textit{deep learning} insume tiempo de cómputo en GPU durante el que se puede avanzar con otras tareas independientes, como la implementación del \textit{pipeline} clásico. Bajo este criterio, se definieron bifurcaciones paralelas en distintos puntos del proyecto.
	
	En la figura \ref{fig:AoN} se presenta el diagrama en bloques. Se observa que el camino crítico del proyecto, resaltado en rojo, atraviesa específicamente la rama del modelo de \textit{deep learning}. Dicha secuencia es la siguiente: 1.1 → 1.3 → 3.1 → 3.2 → 3.3 → 3.4 → 3.5 → 4.1 → 4.3 → 4.4 → 5.1 → 5.2 → 5.3 → 5.5. Esto se debe a que dicha rama insume más tiempo que la implementación del \textit{pipeline} clásico, que queda con una holgura considerable y podría demorarse sin afectar la fecha de finalización del proyecto.
...
El diagrama de Gantt se elaboró a partir de las fechas de inicio y finalización de cada una de las cinco actividades del WBS. Estas se calcularon en función de la duración obtenida en el diagrama de \textit{Activity on Node} y de la fecha de inicio del proyecto (\fechaInicioName). Se incluyen, además, dos hitos: la entrega de la versión final de la memoria al director y la defensa pública del trabajo.

En la figura \ref{fig:diagGantt} se presenta el diagrama de Gantt correspondiente.
	...
	\begin{figure}[htpb]
		\begin{center}
			\begin{ganttchart}[
				...
				]{2026-08-24}{2027-04-15}
				\gantttitlecalendar*{2026-08-24}{2027-04-15}{year} \\
				\gantttitlecalendar*{2026-08-24}{2027-04-15}{month} \\
				\ganttgroup{1. Relevamiento y diseño}{2026-08-24}{2026-09-04} \\
				\ganttbar{1.1 Estado del arte}{2026-08-24}{2026-08-28} \\
				\ganttbar{1.2 Selección datasets}{2026-08-24}{2026-08-26} \\
				\ganttbar{1.3 Arquitectura}{2026-08-31}{2026-09-04} \\
				\ganttbar{1.4 Métricas}{2026-08-31}{2026-09-01} \\
				\ganttgroup{2. Pipeline clásico}{2026-09-07}{2026-10-07} \\
				\ganttbar{2.1 Detección/ROI}{2026-09-07}{2026-09-16} \\
				\ganttbar{2.2 Extracción rPPG}{2026-09-17}{2026-09-25} \\
				\ganttbar{2.3 Estimación HR}{2026-09-28}{2026-10-07} \\
				\ganttbar{2.4 Estimación RR}{2026-09-28}{2026-10-06} \\
				\ganttgroup{3. Modelo deep learning}{2026-09-07}{2026-11-06} \\
				\ganttbar{3.1 Preprocesamiento}{2026-09-07}{2026-09-16} \\
				\ganttbar{3.2 Arquitectura DL}{2026-09-17}{2026-09-30} \\
				\ganttbar{3.3 Entrenamiento}{2026-10-01}{2026-10-14} \\
				\ganttbar{3.4 Hiperparámetros}{2026-10-15}{2026-10-28} \\
				\ganttbar{3.5 Validación}{2026-10-29}{2026-11-06} \\
				\ganttgroup{4. Evaluación}{2026-11-09}{2026-12-04} \\
				\ganttbar{4.1 MAE/RMSE}{2026-11-09}{2026-11-18} \\
				\ganttbar{4.2 Pearson}{2026-11-09}{2026-11-13} \\
				\ganttbar{4.3 Análisis comparativo}{2026-11-19}{2026-11-27} \\
				\ganttbar{4.4 Limitaciones}{2026-11-30}{2026-12-04} \\
				\ganttgroup{5. Documentación y cierre}{2026-12-07}{2027-01-15} \\
				\ganttbar{5.1 Redacción v1}{2026-12-07}{2026-12-16} \\
				\ganttbar{5.2 Revisión director}{2026-12-17}{2026-12-30} \\
				\ganttbar{5.3 Redacción final}{2026-12-31}{2027-01-08} \\
				\ganttbar{5.4 Presentación}{2026-12-17}{2026-12-23} \\
				\ganttbar{5.5 Ensayo defensa}{2027-01-11}{2027-01-15} \\
				\ganttmilestone{Entrega memoria final}{2027-01-08} \\
				\ganttmilestone{Defensa pública}{2027-04-15} \\
			\end{ganttchart}
		\end{center}
...
\end{landscape}
	...
	\label{sec:presupuesto}
		...
		El presupuesto se expresa en dólares estadounidenses (USD), dado que constituye una referencia más estable para valorizar las horas de trabajo profesional. A modo de referencia, se indica la equivalencia en pesos argentinos (ARS) tomando la cotización del dólar informal del 4 de septiembre de 2026, de \$1.540 ARS por dólar.
	
	Los costos directos corresponden a la valorización de las 600 horas de trabajo estimadas en la sección 9, a una tarifa de referencia de USD 17 por hora para un perfil de ingeniería con especialización en inteligencia artificial. Los costos indirectos incluyen la amortización proporcional del equipo (notebook) utilizado durante el desarrollo y la conectividad a internet. Cabe destacar que las principales herramientas de software utilizadas (Python, PyTorch, OpenCV, MediaPipe) son de código abierto y no representan un costo adicional.
	...
	\begin{table}[htpb]
		...
		\begin{tabularx}{\linewidth}{@{}|X|c|r|r|@{}}
			...
			Horas de trabajo del responsable del proyecto &
			\multicolumn{1}{c|}{600 h} &
			\multicolumn{1}{c|}{USD 17,00} &
			\multicolumn{1}{c|}{USD 10.200,00} \\ \hline
			\multicolumn{3}{|c|}{SUBTOTAL COSTOS DIRECTOS} &
			\multicolumn{1}{c|}{USD 10.200,00} \\ \hline
			\rowcolor[HTML]{C0C0C0} 
			...
			\multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor unitario} &
			\multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor total} \\ \hline
			Amortización de notebook personal &
			\multicolumn{1}{c|}{1} &
			\multicolumn{1}{c|}{USD 100,00} &
			\multicolumn{1}{c|}{USD 100,00} \\ \hline
			Conectividad a internet &
			\multicolumn{1}{c|}{1} &
			\multicolumn{1}{c|}{USD 90,00} &
			\multicolumn{1}{c|}{USD 90,00} \\ \hline
			\multicolumn{3}{|c|}{SUBTOTAL COSTOS INDIRECTOS} &
			\multicolumn{1}{c|}{USD 190,00} \\ \hline
			\rowcolor[HTML]{C0C0C0}
	...
	El monto total estimado equivale, a la cotización de referencia indicada, a aproximadamente ARS 16.000.600.
